...
colorlut <- cm.colors(50) # colours
col <- colorlut[cut(mfpt.out$roc[, ncol(mfpt.out$roc):1], 50, labels = FALSE)]
# the angle
userMatrix <- matrix(0, 4, 4)
userMatrix[1, ] <- c(-0.6, 0.6, 0, 0)
userMatrix[2, ] <- c(-0, 0, 1, 0)
userMatrix[3, ] <- c(0.65, 0.65, 0, 0)
...
col <- colorlut[cut(mh.out$roc[, ncol(mh.out$roc):1], 50, labels = FALSE)]
userMatrix <- matrix(0, 4, 4)
userMatrix[1, ] <- c(-0.6, 0.6, 0, 0)
userMatrix[2, ] <- c(-0, 0, 1, 0)
userMatrix[3, ] <- c(0.65, 0.65, 0, 0)
...
col <- colorlut[cut(m1.roc[, ncol(m1.roc):1], 50, labels = FALSE)]
userMatrix <- matrix(0, 4, 4)
userMatrix[1, ] <- c(-0.6, 0.6, 0, 0)
userMatrix[2, ] <- c(-0, 0, 1, 0)
userMatrix[3, ] <- c(0.65, 0.65, 0, 0)
...
col <- colorlut[cut(leh.roc[, ncol(leh.roc):1], 50, labels = FALSE)]
userMatrix <- matrix(0, 4, 4)
userMatrix[1, ] <- c(-0.6, 0.6, 0, 0)
userMatrix[2, ] <- c(-0, 0, 1, 0)
userMatrix[3, ] <- c(0.65, 0.65, 0, 0)
