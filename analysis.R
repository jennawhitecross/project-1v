...
################################################################################
# Scenario 7 - Semi-parametric cover
################################################################################

SP.A.1 <- c(0.70,0.92)
SP.B.1 <- c(0.92,0.96,0.98)

SP.A.2 <- c(0.76,0.90)
SP.B.2 <- c(0.90,1.00,1.00)

SP.A.3 <- c(0.72,0.94)
SP.B.3 <- c(0.94,0.96,0.98)

SP.A.4 <- c(0.72,0.96)
SP.B.4 <- c(0.94,0.94,1.00)

SP.A.5 <- c(0.78,0.96)
SP.B.5 <- c(0.94,0.94,0.96)

SP.B <- c(mean(SP.B.1), mean(SP.B.2), mean(SP.B.3), mean(SP.B.4), mean(SP.B.5))
SP.A <- c(mean(SP.A.1), mean(SP.A.2), mean(SP.A.3), mean(SP.A.4), mean(SP.A.5))

par(mfrow=c(1,1))
x.axis <- 1:5

plot(x.axis, SP.B, type = "b", col = "blue", lwd = 2, pch = 20,
     ylim = c(0.4,1),
     xlab = "Sample Size Scenario", ylab = "Mean Coverage Probability", 
     main = "Semi-Parametric Mean Coverage Probability", cex.main = 1)

lines(x.axis, SP.A, type = "b", col = "red", lwd = 2, pch = 20)

abline(h = 0.95, col = "black", lty = 2, lwd = 2)

legend("bottomright", 
       legend = c("Asymptotic", "Bootstrap", "Nominal Level (0.95)"),
...
SP.A.1 <- c(0.197,0.225)
SP.B.1 <- c(0.229,0.230,0.232)

SP.A.2 <- c(0.163,0.205)
SP.B.2 <- c(0.211,0.210,0.210)

SP.A.3 <- c(0.158,0.180)
SP.B.3 <- c(0.182,0.181,0.182)

SP.A.4 <- c(0.120,0.160)
SP.B.4 <- c(0.156,0.155,0.156)

SP.A.5 <- c(0.115,0.145)
SP.B.5 <- c(0.142,0.141,0.141)
...
plot(x.axis, SP.B, type = "b", col = "blue", lwd = 2, pch = 20,
     ylim = c(0,0.3),
     xlab = "Sample Size Scenario", ylab = "Mean Average Length", 
     main = "Semi-Parametric Mean Average Length", cex.main = 1)
...
################################################################################
# Scenario 7 - Semi-parametric clen
################################################################################

SP.A.1 <- c(0.202,0.228)
SP.B.1 <- c(0.230,0.231,0.234)

SP.A.2 <- c(0.190,0.206)
SP.B.2 <- c(0.210,0.210,0.210)

SP.A.3 <- c(0.165,0.181)
SP.B.3 <- c(0.183,0.187,0.183)

SP.A.4 <- c(0.128,0.161)
SP.B.4 <- c(0.157,0.182,0.156)

SP.A.5 <- c(0.122,0.145)
SP.B.5 <- c(0.141,0.141,0.141)
...
plot(x.axis, SP.B, type = "b", col = "blue", lwd = 2, pch = 20,
     ylim = c(0,0.3),
     xlab = "Sample Size Scenario", ylab = "Mean Conditional Average Length", 
     main = "Semi-Parametric Mean Conditional Average Length", cex.main = 1)
